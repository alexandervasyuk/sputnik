...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      page: 5,                                  // [integer]  which page of results to fetch (if count != fetch, you'll get unexpected results)
      ...
      template: "{avatar} {text} {time}{join}",  // [string or function] template used to construct each tweet <li> - see code for available vars
    ...
    $.fn.extend({
      ...
      linkHash: replacer(/(?:^| )[\#]+([\w\u00c0-\u00d6\u00d8-\u00f6\u00f8-\u00ff\u0600-\u06ff]+)/gi,
                         ...
                         '" class="tweet_hashtag" target="_blank">#$1</a>'),
    ...
    function extract_template_data(item){
      ...
      o.time = t('<span class="tweet_time"><a href="{tweet_url}" title="view tweet on twitter" target="_blank">{tweet_relative_time}</a></span>', o);
