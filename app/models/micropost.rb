class Micropost < ActiveRecord::Base
  ...
  def to_mobile
	...
	self.participations.each do |participation|
  	...
  	{id: self.id, creator_picture: self.user.avatar.url, creator_name: self.user.name, event_title: self.content, event_location: self.location, event_time: self.time, latitude: self.latitude, longitude: self.longitude, address: self.address, participations: participants}
  end
